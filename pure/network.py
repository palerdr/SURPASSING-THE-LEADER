"""Small policy/value network for the canonical pure game."""
...
class PurePolicyValueNet(nn.Module):
    """Shared MLP with current-role value, Dropper, and Checker heads."""

    def __init__(self, config: PureNetworkConfig | None = None) -> None:
        super().__init__()
        self.config = config or PureNetworkConfig()
