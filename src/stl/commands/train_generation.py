...
Usage:
    python scripts/run_gen_iteration.py \
        --in-checkpoint src/stl/checkpoints/gen1_v8/best.pt \
        --out-dir src/stl/checkpoints/gen2/ \
        --out-targets src/stl/checkpoints/gen2_targets.npz \
        --anchor-targets src/stl/checkpoints/gen0_targets.npz \
        --held-out-targets src/stl/checkpoints/holdout_targets.npz \
        --iterations 1000 \
        --epochs 150
