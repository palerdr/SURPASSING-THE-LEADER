...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--train", default="src/stl/outputs/regen2rl/gen0_train_v3.npz")
    parser.add_argument(
        "--ruler", default="src/stl/outputs/regen2rl/gen0_external_ruler_v3.npz"
    )
    ...
    parser.add_argument(
        "--out",
        default="src/stl/outputs/regen2rl/gen0_external_ruler_report_v3.json",
    )
