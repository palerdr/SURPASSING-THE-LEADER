...
from arena.policies.aggro_env import AggroSessionEnv
from arena.policies.evaluate_bayesian_hal import ExactProvider, UniformProvider, cluster_interval, hard_response
from arena.policies.evaluate_translated_hal import OffsetOpponent
from arena.policies.neural_pilots import PublicMemory, make_network, tensor
from arena.policies.opponent_league import SUPPORTED_FAMILIES, ReactiveDTHOpponent
...
class Experiment:
    ...
    def input_hashes(self):
        ...
        paths += [Path(__file__).with_name(n + ".py") for n in ("aggro_env", "aggro_hal", "opponent_league",
