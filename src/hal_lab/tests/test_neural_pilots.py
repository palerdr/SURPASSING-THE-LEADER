...
from hal_lab.experiments.neural_pilots_v1.neural_pilots import ExpertSelector, PublicMemory, SequencePredictor, SessionActor, TOKEN_DIM, WINDOW
...
def test_shuffle_randomness_cannot_change_actions_if_predictions_match(monkeypatch, tmp_path):
    from hal_lab.experiments.neural_pilots_v1.run_neural_pilots import Experiment
