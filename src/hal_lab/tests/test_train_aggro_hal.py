...
import hal_lab.training.train_aggro_hal as train_aggro_hal
...
from hal_lab.harness.opponent_league import EARLY, LATE
from hal_lab.training.train_aggro_hal import (
