...
from hal_lab.harness.opponent_league import (
    TRAIN_FAMILY_MANIFEST,
    OpponentFamilyManifest,
    make_opponent,
)
from hal_lab.training.aggro_env import (
    ACTION_COUNT,
    AggroSessionEnv,
)
from hal_lab.training.aggro_memory_curriculum import (
    MemoryCurriculumArm,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m hal_lab.training.train_aggro_hal")
