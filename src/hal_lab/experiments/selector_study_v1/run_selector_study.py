...
from hal_lab.experiments.neural_pilots_v1.neural_pilots import PublicMemory
from hal_lab.experiments.neural_pilots_v1.run_neural_pilots import (
    Experiment, TRAIN_FAMILIES, VALIDATION_FAMILIES, TEST_FAMILIES, UNSEEN_FAMILIES,
    load_network, sha, write,
)
from hal_lab.experiments.perfect_hal_bayes_v2.evaluate_bayesian_hal import cluster_interval, hard_response
from hal_lab.experiments.selector_study_v1.selector_study import Selector, SelectorEnsemble
...
class Study(Experiment):
    def __init__(self, args):
        super().__init__(args)
        evidence = json.loads(Path("src/hal_lab/experiments/neural_pilots_v1/neural_pilots_v1_results.json").read_text())
    ...
    def input_hashes(self):
        ...
        paths = [Path(__file__), Path(__file__).with_name("selector_study.py"), self.args.prior / "selector.pt",
            Path("src/hal_lab/experiments/neural_pilots_v1/neural_pilots_v1_results.json")]
