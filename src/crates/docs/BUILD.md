...
contract is `src/abstract/docs/PACKED_TABLEBASE_PARITY.md`.
...
`src/crates/dth_complete` is an opt-in PyO3 + rayon accelerator for the DTH
packed-quotient backward sweep. Python (`src/dth/complete_tablebase.py`) remains
...
contract is `src/dth/docs/DTH_COMPLETE_PARITY.md`.
