...
class ToyState:
    ...
    The v0 ruleset uses only ``hal_load``, ``baku_load``, and ``role_phase``.
    The remaining fields are intentionally inert in v0 and become active in
    the later versioned rulesets.
    """
