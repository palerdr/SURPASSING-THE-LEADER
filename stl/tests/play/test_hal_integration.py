...
from stl.play.state import BeliefState, HalState, MemoryMode
from stl.play.state import update_memory
from stl.play.state import update_belief
...
class TestBelief:
    def _make_record(self, dropper="Hal", checker="Baku", drop_time=30, check_time=55):
        from stl.engine.game import HalfRoundRecord, HalfRoundResult
...
class TestSearchMemoryRecursion:
    ...
    def test_memory_can_advance_when_simulating_into_leap_window(self):
        ...
        from stl.engine.game import Referee
        from stl.engine.game import PHYSICALITY_HAL, PHYSICALITY_BAKU
        from stl.play.search import search
